...
- **Flight / recording timestamp:** 2026-07-10 21:59:46
- **Flight duration:** 88.2 s (OK; minimum 15 s)
- **World (ground truth):** `simulation/gazebo/worlds/course_3_dogleg.sdf`
- **Detection log:** `simulation/sim_tests/run_8/detections_20260710_215938.csv`
- **Datum:** lat -35.363262, lon 149.165237

## Summary

- Total logged detections: **238**
- Colour buoys detected: **6 / 8**
- Mean horizontal error: **0.14 m**
- Max horizontal error: **0.56 m**
- Mean detection confidence: **0.95**
- Unmatched detections (no buoy within 3.0 m): **2**

## Per-buoy accuracy

| Buoy | Colour | True N,E (m) | Detections | Mean err (m) | Max err (m) | Mean conf |
|------|--------|--------------|-----------:|-------------:|------------:|----------:|
| gate1_green | green | 1.25, 10.00 | 42 | 0.15 | 0.56 | 0.97 |
| gate1_red | red | -1.25, 10.00 | 42 | 0.15 | 0.55 | 0.88 |
| gate2_green | green | 1.25, 25.00 | 38 | 0.13 | 0.31 | 0.97 |
| gate2_red | red | -1.25, 25.00 | 38 | 0.13 | 0.30 | 0.87 |
| gate3_green | green | 15.00, 36.25 | 38 | 0.15 | 0.42 | 1.00 |
| gate3_red | red | 15.00, 33.75 | 0 | - | - | - |
| gate4_green | green | 30.00, 36.25 | 38 | 0.15 | 0.35 | 1.00 |
